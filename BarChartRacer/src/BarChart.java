 ...
 * drawing all of the bars to the screen using standard draw. The bars are drawn
 * horizontally (in the order in which they are added from top to bottom) and
 * colored according to the category. The name and value of the bar and drawn
 * with the bar.
 *
 * @author Kevin Wayne
 */
public class BarChart {
    ...
    private ArrayList<String> countries;      // list o country names  
    ...
    private ArrayList<Boolean> countryNameVisibilityList;

    /**
     * Creates a new bar chart with the given title, x-axis label, and data
     * source.
     *
     ...
     * automatially). This method is useful if you know that the values stay
    ...
    /**
     * Sets the caption of this bar chart. The caption is drawn in the
    ...
    /**
     * Adds a bar to the bar chart. The length of a bar is proportional to its
     * value. The bars are drawn from top to bottom in the order they are added.
     * All bars from the same category are drawn with the same color.
     *
     * @param name the name of the bar
     * @param country the country of the bar
     * @param value the value of the bar
     * @param category the category of bar
     *
     */
    public void add(String name, String country, int value, String category) {
        if (name == null) {
            throw new IllegalArgumentException("name is null");
        }
        if (country == null) {
     ...
     *
     *
     * @param font font type of the bar
     * @param countryVisibility check country name visibility of the bar
     */
    public void factoryFeatures(String font, boolean countryVisibility) {
        if (font == null) {
            throw new IllegalArgumentException("font is null");
        }
        fontList.add(font);
        countryNameVisibilityList.add(countryVisibility);
    ...
    public void reset() {
        ...
        countryNameVisibilityList = new ArrayList<Boolean>();
        caption = "";
    }
    ...
    public void draw() {
        ...
        for (int i = 0; i < names.size(); i++) {
            ...
            Boolean visible = countryNameVisibilityList.get(i);
            if (visible) {
            ...
            StdDraw.setFont(new Font(font, Font.BOLD, fontSize));
            StdDraw.textRight(value - 0.01 * xmax, numberOfBars - i - 0.5, name);
            StdDraw.textRight(value - 0.01 * xmax, numberOfBars - i - 0.7, country);
            StdDraw.setFont(new Font(font, Font.PLAIN, fontSize));
